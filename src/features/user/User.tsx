            ...
            {user && (
                <div className="h-16 bg-main border-t border-main-black flex items-center px-3">
                    ...
                    <Tooltip placement="top" content="Logout">
                        <button
                            type="button"
                            className="inline-flex items-center p-2 mr-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-full text-white hover:bg-main-accent hover:bg-opacity-25"
