...
export default function UserListItem({ user }: { user: User }): JSX.Element {
    ...
    return (
        <div className="my-2">
            <UserPopover user={user} placement='left'>
                <div className='py-1 hover:bg-indigo-500 hover:bg-opacity-10 border-l-2 border-transparent hover:border-indigo-500 hover:border-opacity-50'>
